...
I copied from https://github.com/karpathy/minGPT/blob/master/mingpt/bpe.py
"""
...
class BPETokenizer:
    """ TF-aware class that wraps the Encoder above """

    def __init__(self):
        self.encoder = get_encoder()

    def __call__(self, text, return_tensors='tf'):
        # TF only; here because we want to match huggingface/transformers interface
        assert return_tensors == 'tf'
